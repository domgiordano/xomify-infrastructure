...
Terraform IaC for Xomify - music analytics platform at [xomify.xomware.com](https://xomify.xomware.com).
...
**Terraform Workspace:** [xomify-infrastructure](https://app.terraform.io/app/Domjgiordano/workspaces/xomify-infrastructure)
...
- **Lambda** - Python 3.13 functions (user, wrapped, friends, groups, ratings, release-radar, cron)
- **DynamoDB** - User data, wrapped snapshots, ratings
- **SES** - Email service (noreply@xomify.xomware.com)
